...
int main(int argc, char** argv) {
    ...
    try {
        ...
        Parser parser;
        std::unique_ptr<PDA> pda = parser.parseFromFile(filename);
        ...
        std::cout << "Acceptance Mode: " << (pda->acceptanceMode() == AcceptanceMode::FinalState ? "Final State" : "Empty Stack") << std::endl;
